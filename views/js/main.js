...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
	...
	var randomPizCont = document.getElementsByClassName("randomPizzaContainer");
	var randomPizContLength = randomPizCont.length;
    for (var i = 0; i < randomPizContLength; i++) {
      randomPizCont[i].style.width = newwidth + '%';
    }
  }
